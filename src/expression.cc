...
// ----------------------------------------------------------------------------
{
    ...
    expression_g result = eq->rewrites(
        ...
        sin(X)|indep,           cos(X)*(X|indep),
        cos(X)|indep,           -sin(X)*(X|indep),
        tan(X)|indep,           (one + sq(tan(X)))*(X|indep),
        sinh(X)|indep,          cosh(X)*(X|indep),
        cosh(X)|indep,          sinh(X)*(X|indep),
        tanh(X)|indep,          (X|indep)/(cosh(X)),
