...
//ref Commissions romandes de mathématique, de physique et de chimie, Formulaires et tables : Mathématiques, Physique, Chimie, Tricorne, 2000, 278
...
* `Qβ-`: Net energy balance of a β- disintegration (dim.: energy, in SI: MeV)
* `Qβ+`: Net energy balance of a β- disintegration (dim.: energy, in SI: MeV)
...
![Planck & Wien Comparison](Planck, Wien Distr_BW.bmp)
...
![Planck & Rayleigh-Jeans Comparison](Planck,Rayleigh-Jeans Distr_BW.bmp)
