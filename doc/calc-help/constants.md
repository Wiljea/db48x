...
sample of matter. It's an exact constant. [0]
...
calculated by the following expression: `NA·u`. [0]
...
the redifinition of the mole, it is calculated exactly as: `NA·Vm`. [0]
...
monoatomic ideal gas in terms of its thermodynamic state. [0]
...
directed along the line connecting their centres of mass [0]:
...
black body's temperature, T:`M°=σ·T⁴`. [0]
...
Its value depends on the vaccuum permeability constant `μ0`. [0]
...
fine structure constant measurement `α`. [0]

### ke constant

Coulomb constant as it appears in the expression of the Coulomb force:
`Fe=ke·q1·q2/r^2`. Its value depends on the vacuum permittivity `ε0`. [0]
...
calculated with the fine structure constant `α` and the Rysberg constant `R∞`. [0]
...
determined by particle drag race experiments. [0]
...
the nucleus by the Coulomb force. Its mass is measured by spectrometry. [0]
...
Its mass is measured by spectrometry. [0]
...
is evaluated from energy conservation budget in pair creation reaction. [0]
...
evaluated from energy conservation budget in pair creation reaction. [0]
...
did, but rely on measuring (cyclotron) frequencies rather than deflection. [0]
...
is determined iteratively by frequency measurements using Penning trap. [0]
...
spectroscopy and QCD sum rules. [2]

### mQstr constant

Strange quark mass. A light quark whose mass is determined from QCD sum 
rules and lattice calculations. Value in `MeV/c²`. [2]

### mQdwn constant

Down quark mass. One of the two lightest quarks forming ordinary matter. 
Its mass is determined from lattice QCD calculations. Value in `MeV/c²`. [2]
...
upper bounds are currently measurable. [2]

### mνmin constant

Minimum neutrino mass lower bound consistent with neutrino oscillation 
experiments, expressed in `eV/c²`. [2]
...
8 and 13 TeV proton-proton collision data. [15]
...
decreasing the likelihood that the 2022 CDF II result indicated new physics. [16]
...
with value `1.60217733⁳⁻¹⁹` coulombs. [0]
...
precisely measured values in physics. [0]
...
magnetic moment revealing its existence. It's a measured quantity. [0]
...
depends on the electron mass `me`. [0]
...
it depends on the measured value of the proton mass `mp`. [0]
...
field. Its value depends on the electron magnetic moment `μe`. [0]
...
Its value depends on the proton magnetic moment `μp`. [0]
...
expression (using Lambert W function), it's an exact constant. [0]
...
magnetic fields. It's an exact constant. [0]
...
a quantum conductor to its quantum properties. It's an exact constant. [0]
...
decay. It's a measured quantity. [0]
...
any superconductor. It's an exact constant. [0]
...
depends on fine structure constant `α`. [0]
...
electron radius `re`, its value depends on fine structure constant `α`. [0]
...
SI redefinition, it has an exact value. [0]

### ℏ constant

The reduced Planck constant, ℏ, also known as the Dirac Constant, is
exactly defined as `ℏ=h/2π`. [0]
...
Caesium atom. By convention this constant is exact. [0]
...
for the W and Z bosons: `(sinθw)^2 = 1 - (mW/mZ)^2 = 0.22305 ± 0.00023`. [0]
...
measured value of the gravitational constant `G`. [0]
...
of the gravitational constant `G`. [0]
...
value of the gravitational constant `G`. [0]
...
defined as `qpl=√(4π·ε₀·ℏ·c)`. Its value depends on the vacuum permittivity `ε₀`. [0]

### ppl — Planck momentum

The Planck momentum unit is the natural unit of momentum in Planck units, defined 
as `ppl=√(ℏ·c³/G)`. Its value depends on the gravitational constant `G`. [0]
...
depends on the gravitational constant `G`. [0]

### ρvpl — Planck density

The Planck density unit is the natural unit of density in Planck units, defined 
as `ρvpl=c⁵/(ℏ·G²)`. Its value depends on the gravitational constant `G`. [0]
...
measured value of the Rydberg constant `R∞`. [0]
...
It is measured by radio tracking of spacecraft (Mariner 10, MESSENGER). [4]

### Req☿ — Mercury equatorial radius

It is measured by radar altimetry and spacecraft imaging. [22]

### Rp☿ — Mercury polar radius

Mercury's polar radius is also measured, since Mercury being essentially 
spherical; equatorial and polar radii are equal within measurement precision. [22]

### f☿ — Mercury oblateness

Mercury's oblateness is calculated from its equatorial and polar radii measurement. 
Due to Mercury's near-spherical shape, this value is effectively zero. [22]

### ρv☿ — Mercury mean density

It is calculated from measurement of its gravitational parameter and volume. 
Its high density indicates a large metallic core. [4] [22]
...
Mercury's gravitational pull and never return. [4] [22]
...
the Sun, rotating three times for every two orbits. [22]
...
angle of the planet's rotational axis relative to its orbital plane. [22]
...
distance from one of the radii to the orbit. [23]
...
planet's elliptical path deviates from a perfect circle. [23]
...
northward through Earth's orbital plane. [23]
...
Sun), measured in the direction of motion. [23]
...
orbit when it was closest to the Sun. [M20]
...
rotation period longer than its orbital period. [22]

### ϵ♀ — Venus axial tilt

Measured. Venus's axial tilt. The near-180° value reflects its retrograde rotation. 
It is the angle of the planet's rotational axis relative to its orbital plane. [22]
...
of the radii to the orbit. [23]

### e♀ — Venus orbital eccentricity

Measured. Venus's orbital eccentricity, nearly circular (therefore, near 0). [23]
...
minimum speed needed to break free from Earth's gravitational pull and never return. [3]

### Prot🜨 — Earth sidereal rotation period

Measured. Earth's sidereal rotation period (one sidereal day), the time for one 
rotation relative to the fixed stars. [24]
...
Measured. Earth's orbital eccentricity (low since the orbit is nearly circular) . [23]
...
and spacecraft radio tracking. [4]

### Req☽ — Moon equatorial radius

Measured. Moon's equatorial radius, measured by laser altimetry (LRO mission). [22]

### Rp☽ — Moon polar radius

Measured. Moon's polar radius. [22]
...
silicate composition with a small iron core. [4] [22]
...
average distance from one of the radii to the orbit. [25]
...
deviates from a perfect circle. [25]
...
(15 terms, ±1 hour accuracy). Value in JDN. [M20] [M22]
...
its moons Phobos and Deimos, measured by spacecraft radio tracking. [4]

### Req♂ — Mars equatorial radius

Measured. Mars's equatorial radius. [22]

### Rp♂ — Mars polar radius

Measured. Mars's polar radius. Mars is noticeably oblate due to its rotation. [22]

### f♂ — Mars oblateness

Calculated from measurement. When greater than 0, it describes how much a 
celestial body deviates from a perfect sphere, forming an "oblate spheroid". [22]

### ρv♂ — Mars mean density

Calculated from measurement. Mars's mean density, intermediate between rocky 
and metallic compositions. [4] [22]
...
one of the radii to the orbit. [23]
...
path deviates from a perfect circle. [23]
...
in its orbit when it was closest to the Sun. [M20]
...
due to its gaseous composition. [3]
...
where Jupiter crosses northward through Earth's orbital plane. [23]
...
point to the Sun), measured in the direction of motion. [23]
...
in its orbit when it was closest to the Sun. Value in JDN. [4] [M21]
...
tracking of the Cassini spacecraft. [4]

### Req♄ — Saturn equatorial radius

Measured. Saturn's equatorial radius at the 1-bar pressure level. [22]

### Rp♄ — Saturn polar radius

Measured. Saturn's polar radius at the 1-bar pressure level. [22]
...
axis relative to its orbital plane.. [22]
...
crosses northward through Earth's orbital plane. [23]
...
Measured. Uranus's polar radius. [22]
...
it rotates almost on its side. [22]
...
2 radio tracking and Hubble Space Telescope astrometry of Triton. [4]
...
Measured. Neptune's polar radius. [22]
...
the planet's rotational axis relative to its orbital plane. [22]
...
Measured. Pluto's polar radius. Pluto is essentially spherical. [26]
...
axis relative to its orbital plane. [26]
...
of how much a planet's elliptical path deviates from a perfect circle. [23]

### i♇ — Pluto orbital inclination

Pluto's orbital inclination is a measured angle with respect to the ecliptic 
plane, ir is the highest of any solar system body traditionally listed. [23]
...
`GM☉` and the measured gravitational constant `G`. [2] [3] [5]

### GM☉ — Solar gravitational parameter

It is an exact nominal value defined by the International Astronomical 
Union (IAU 2015 Resolution B3). [3]

### L☉ — Solar luminosity

It is an exact nominal value defined by the IAU (2015). [3]
...
to break free from Sun's gravitational pull and never return. [3]
...
time it takes to spin 360° on its axis. [20] [21]
...
of the large-scale structure and expansion of the universe. [1] [2]
...
microwave background and Type Ia supernovae. [1]
...
measured from the cosmic microwave background power spectrum. [1]
...
the position of the first acoustic peak in the CMB power spectrum. [1]
...
satellite galaxy dynamics. [8] [9] [10]
...
estimated from star count surveys and kinematic models. [8] [9]
...
standard in stellar astronomy. [13] [14]
...
and pressure (101.325 kPa). [M1] [M2]

### nAir — Refractive index of dry air

Measured. Refractive index of dry air at 589 nm (sodium D line), 0°C, 
1 atm. Varies slightly with humidity and CO2 content. [M2]

### cpAir — Specific heat cp of dry air

Measured. Specific heat of dry air at constant pressure at 300 K. [M1] [M2]
...
form in response to electric charges. [M1] [M2]
...
opposes the flow of electric current. [M1] [M2]
...
(lightning, spark discharge). [M1] [M2]
...
Measured. Specific heat of N2 at constant pressure. [M2] [M3]

### cvN2 — Dinitrogen N2 specific heat cv

Measured. Specific heat of N2 at constant volume. [M2] [M3]

### γN2 — Dinitrogen N2 adiabatic index

Measured. Adiabatic index of N2, γ=cp/cv. [M2] [M3]

### RN2 — Dinitrogen N2 specific gas constant

Exact calculation: `R/M_N2`. Specific gas constant of N2, `RN2=R/M_N2`, 
where `M_N2=28.014 g/mol`. [M2]
...
to form in response to electric charges. [M2]
...
induced by an electric current. [M2]
...
material opposes the flow of electric current. [M2]
...
field threshold above which an avalanche ionisation occurs. [M2]
...
Measured. Specific heat of O2 at constant pressure. [M2] [M3]

### cvO2 — Dioxygen O2 specific heat cv

Measured. Specific heat of O2 at constant volume. [M2] [M3]

### γO2 — Dioxygen O2 adiabatic index

Measured. Adiabatic index of O2, `γ=cp/cv`, at `300 K`. [M2] [M3]

### RO2 — Dioxygen O2 specific gas constant

Exact calculation: `R/M_O2`. Specific gas constant of O2, `RO2=R/M_O2`, 
where `M_O2=31.999 g/mol`. [M2]
...
field is "permitted" to form in response to electric charges. [M2]
...
of the magnetic field induced by an electric current. [M2]
...
air due to absence of polar molecules. [M2]
...
a material opposes the flow of electric current. [M2]
...
at `20°C`. Near its minimum value in the `0–100°C` range. [M4] [M2]
...
index of crystalline silicon at `1150 nm`, `20°C`. [M11]

### cpSi — Specific heat of silicon

Measured. Specific heat of crystalline silicon at `300 K`. [M10]
...
the primary material for standard optical fibers. [M5] [M7]
...
from Malitson (1965) is the standard reference for fiber optic design. [M5]

### cpSiO2 — Specific heat of fused silica

Measured. Specific heat of fused silica at `20°C`. [M7]
...
how strongly a material opposes the flow of electric current. [M7]

### EdSiO2 — Dielectric rigidity of fused silica

Measured. Dielectric breakdown electric field of fused silica. Very high; 
SiO2 is the standard gate dielectric in MOSFET technology. [M7]
...
Measured. Specific heat of germanate glass. [M9]
...
and stoichiometry. [M18]

### cpSi3N4 — Specific heat of Si3N4

Measured. Specific heat of silicon nitride. [M19]
...
how strongly a material opposes the flow of electric current. [M19]

### EdSi3N4 — Dielectric rigidity of Si3N4

Measured. Dielectric breakdown electric field of Si3N4 thin films. Higher than 
SiO2; used as storage dielectric in SONOS flash memory. [M19]
...
most widely used optical glass for visible-range optics. [M15]
...
Measured. Specific heat of BK7 glass. [M15]
...
used for UV-to-IR windows, substrates, and high-power laser rods. [M16]
...
index is slightly higher. [M16]

### cpAl2O3 — Specific heat of sapphire

Measured. Specific heat of sapphire at `300 K`. [M16] [M2]
...
enables use in high-field capacitors and microwave devices. [M16]
...
Measured. Specific heat of calcium fluoride. [M15]
...
how strongly a material opposes the flow of electric current. [M17]

### EdCaF2 — Dielectric rigidity of CaF2

Measured. Dielectric breakdown electric field of CaF2 crystal. Very high; 
consistent with use in high-power UV laser optics. [M17]
...
Measured. Specific heat of diamond at `300 K`. [M13]
...
strongly a material opposes the flow of electric current. [M13] [M14]
...
material in mechanical and thermal engineering. [M12] [M2]

### cpAl — Specific heat of aluminium

Measured. Specific heat of pure aluminium at `20°C`. [M12] [M2]
...
thermal and electrical conductivity in engineering. [M12] [M2]

### cpCu — Specific heat of copper

Measured. Specific heat of copper at `20°C`. [M12] [M2]
...
phase (body-centred cubic), stable below `912°C`. [M12] [M2]
...
### Primary physics data
[0] CODATA 2022: Fundamental Physical Constants. National Institute of Standards and Technology (NIST). URL: https://physics.nist.gov/cuu/pdf/wall_2022.pdf Applies to all unspecified sources for fundamental physical constants.
[1] Planck Collaboration (2020). "Planck 2018 results. VI. Cosmological parameters". Astronomy & Astrophysics, 641, A6. arXiv:1807.06209 — DOI: 10.1051/0004-6361/201833910
[2] Particle Data Group (2024). "Review of Particle Physics — Astrophysical Constants". Physical Review D, 110, 030001. DOI: 10.1103/PhysRevD.110.030001
[3] Prša, A., et al. (2016). "Nominal values for selected solar and planetary quantities: IAU 2015 Resolution B3". The Astronomical Journal, 152(2), 41. arXiv:1605.09788 — DOI: 10.3847/0004-6256/152/2/41
[4] Park, R.S., et al. (2021). "The JPL Planetary and Lunar Ephemerides DE440 and DE441". The Astronomical Journal, 161(3), 105. DOI: 10.3847/1538-3881/abd414
[5] Tiesinga, E., et al. (2021). "CODATA recommended values of the fundamental physical constants: 2018". Reviews of Modern Physics, 93(2), 025010. DOI: 10.1103/RevModPhys.93.025010

### Galactic and extragalactic data
[6] GRAVITY Collaboration (2021). "Mass distribution in the Galactic Center based on interferometric astrometry of multiple stellar orbits". Astronomy & Astrophysics, 647, A59. arXiv:2012.02169 — DOI: 10.1051/0004-6361/202040208
[7] Event Horizon Telescope Collaboration (2022). "First Sagittarius A* Event Horizon Telescope Results. I. The Shadow of the Supermassive Black Hole in the Center of the Milky Way". The Astrophysical Journal Letters, 930(2), L12. arXiv:2311.08680 — DOI: 10.3847/2041-8213/ac6674
[8] Eilers, A.-C., et al. (2019). "The Circular Velocity Curve of the Milky Way from 5 to 25 kpc". The Astrophysical Journal, 871(1), 120. arXiv:1810.09466 — DOI: 10.3847/1538-4357/aaf648
[9] Watkins, L.L., et al. (2019). "Evidence for an Intermediate-Mass Milky Way from Gaia DR2 Halo Globular Cluster Motions". The Astrophysical Journal, 873(2), 118. arXiv:1804.11348 — DOI: 10.3847/1538-4357/ab089f
[10] Posti, L., & Helmi, A. (2019). "Mass and shape of the Milky Way's dark matter halo with globular clusters from Gaia and Hubble". Astronomy & Astrophysics, 621, A56. arXiv:1805.01408 — DOI: 10.1051/0004-6361/201833355
[11] Peñarrubia, J., et al. (2014). "A timing constraint on the (total) mass of the Large Magellanic Cloud". Monthly Notices of the Royal Astronomical Society, 443(3), 2204–2222. arXiv:1405.4662 — DOI: 10.1093/mnras/stu879
[12] Veljanoski, J., et al. (2014). "The M31 satellite plane: Evidence for a recent flyby?" Monthly Notices of the Royal Astronomical Society: Letters, 442(1), L86–L90. arXiv:1404.5988 — DOI: 10.1093/mnrasl/slu050
[13] Yoon, J., et al. (2010). "A New View of Vega's Composition, Mass, and Age". The Astrophysical Journal, 708(1), 71–79. arXiv:0910.3124 — DOI: 10.1088/0004-637X/708/1/71
[14] Aufdenberg, J.P., et al. (2006). "First Results from the CHARA Array. VII. Long-Baseline Interferometric Measurements of Vega Consistent with a Pole-On, Rapidly Rotating Star". The Astrophysical Journal, 645(1), 664–675. arXiv:astro-ph/0603327 — DOI: 10.1086/504149

### Particle physics data
[15] ATLAS-CONF-2023-037: "ATLAS sets record precision on Higgs boson's mass" (CERN, July 21, 2023).
[16] CMS Collaboration (2026): "High-precision measurement of the W boson mass with the CMS experiment", Nature (published online April 8, 2026).
[17] LEP Electroweak Working Group, "A Combination of Preliminary Electroweak Measurements and Constraints on the Standard Model," arXiv:hep-ex/0605011, often summarized in Physics Reports 427 (2006) 257–454.
Solar data
[18] Haberreiter, M., Schmutz, W., & Kosovichev, A.G. (2008). "Solving the Discrepancy between the Seismic and Photospheric Solar Radius". The Astrophysical Journal Letters, 675(1), L53–L56. DOI: 10.1086/529492
[19] Mamajek, E.E., et al. (2015). "On the Age and Binarity of Fomalhaut". The Astrophysical Journal, 800(2), L17. arXiv:1412.5018 — DOI: 10.1088/2041-8205/800/2/L17
[20] Snodgrass, H.B., & Ulrich, R.K. (1990). "Rotation of Doppler features in the solar photosphere". The Astrophysical Journal, 351, 309–316. DOI: 10.1086/168467
[21] Beck, J.G. (2000). "A comparison of differential rotation measurements". Solar Physics, 191(1), 47–70. DOI: 10.1023/A:1005226402796

### Planetary and lunar data
[22] Archinal, B.A., et al. (2018). "Report of the IAU Working Group on Cartographic Coordinates and Rotational Elements: 2015". Celestial Mechanics and Dynamical Astronomy, 130(3), 22. DOI: 10.1007/s10569-017-9805-5
[23] NASA JPL Solar System Dynamics — Horizons On-Line Ephemeris System. URL: https://ssd.jpl.nasa.gov/horizons/ Accessed: February 2026. Epoch: J2000.0 (JD 2451545.0)
[24] Seidelmann, P.K., & Fukushima, T. (1992). "Why new time scales?" Astronomy & Astrophysics, 265(2), 833–838.
[25] Williams, J.G., et al. (2014). "Lunar interior properties from the GRAIL mission". Journal of Geophysical Research: Planets, 119(7), 1546–1578. DOI: 10.1002/2013JE004559
[26] Nimmo, F., et al. (2017). "Mean radius and shape of Pluto and Charon from New Horizons images". Icarus, 287, 12–29. arXiv:1603.00821 — DOI: 10.1016/j.icarus.2016.06.027

### Materials & Fluids data
[M1] Lemmon, E.W., Jacobsen, R.T., Penoncello, S.G., & Friend, D.G. (2000). "Thermodynamic Properties of Air and Mixtures of Nitrogen, Argon, and Oxygen from 60 to 2000 K at Pressures to 2000 MPa". J. Phys. Chem. Ref. Data, 29(3), 331–385. DOI: 10.1063/1.1285884
[M2] NIST WebBook of Chemistry (2024). National Institute of Standards and Technology. URL: https://webbook.nist.gov/chemistry/ — Accessed: March 2026
[M3] Chase, M.W. (1998). NIST-JANAF Thermochemical Tables, 4th ed. J. Phys. Chem. Ref. Data, Monograph 9. American Chemical Society / AIP.
[M4] Wagner, W., & Pruss, A. (2002). "The IAPWS Formulation 1995 for the Thermodynamic Properties of Ordinary Water Substance for General and Scientific Use". J. Phys. Chem. Ref. Data, 31(2), 387–535. DOI: 10.1063/1.1461829
[M5] Malitson, I.H. (1965). "Interspecimen Comparison of the Refractive Index of Fused Silica". J. Opt. Soc. Am., 55(10), 1205–1209. DOI: 10.1364/JOSA.55.001205
[M6] Palik, E.D. (Ed.) (1985). Handbook of Optical Constants of Solids. Academic Press, New York. ISBN: 0-12-544420-6
[M7] Corning Incorporated (2023). Corning HPFS Fused Silica — Standard Grade Optical Properties. Product datasheet. URL: https://www.corning.com
[M8] Fleming, J.W. (1984). "Dispersion in GeO2-SiO2 glasses". Applied Optics, 23(24), 4486–4493. DOI: 10.1364/AO.23.004486
[M9] Dianov, E.M., & Guryanov, A.N. (2010). "High-power Raman fiber lasers". Quantum Electronics, 40(7), 579–599. DOI: 10.1070/QE2010v040n07ABEH014211
[M10] Glassbrenner, C.J., & Slack, G.A. (1964). "Thermal Conductivity of Silicon and Germanium from 3°K to the Melting Point". Physical Review, 134(4A), A1058–A1069. DOI: 10.1103/PhysRev.134.A1058
[M11] Hull, R. (Ed.) (1999). Properties of Crystalline Silicon. EMIS Datareviews Series No. 20. IEE, London. ISBN: 0-85296-933-3
[M12] Ho, C.Y., Powell, R.W., & Liley, P.E. (1972). "Thermal Conductivity of the Elements". J. Phys. Chem. Ref. Data, 1(2), 279–421. DOI: 10.1063/1.3253100
[M13] Slack, G.A. (1973). "Nonmetallic crystals with high thermal conductivity". J. Phys. Chem. Solids, 34(2), 321–335. DOI: 10.1016/0022-3697(73)90092-9
[M14] Zaitsev, A.M. (2001). Optical Properties of Diamond: A Data Handbook. Springer, Berlin. ISBN: 3-540-66603-8
[M15] Schott AG (2023). Optical Glass Data Sheets. URL: https://www.schott.com/en-gb/products/optical-glass — Accessed: March 2026
[M16] Dobrovinskaya, E.R., Lytvynov, L.A., & Pishchik, V. (2009). Sapphire: Material, Manufacturing, Applications. Springer, Boston. ISBN: 978-0-387-85694-0
[M17] Burnett, J.H., Levine, Z.H., & Shirley, E.L. (2001). "Intrinsic birefringence in calcium fluoride and barium fluoride". Physical Review B, 64(24), 241102. DOI: 10.1103/PhysRevB.64.241102
[M18] Luke, K., Okawachi, Y., Lamont, M.R.E., Gaeta, A.L., & Lipson, M. (2015). "Broadband mid-infrared frequency comb generation in a Si3N4 microresonator". Optics Letters, 40(21), 4823–4826. DOI: 10.1364/OL.40.004823
[M19] NIST Materials Measurement Laboratory (2024). Materials Properties Database. URL: https://trc.nist.gov/ — Accessed: March 2026
[M20] Espenak, F. (2025–2026). Sky Event Almanacs — Greenwich Mean Time. AstroPixels.com. URL: https://www.astropixels.com/almanac/almanac21/ Accessed: April–May 2026. (Source for perihelion/perigee dates of inner planets and Moon.)
[M21] Park, R.S., et al. (2021). "The JPL Planetary and Lunar Ephemerides DE440 and DE441". The Astronomical Journal, 161(3), 105. DOI: 10.3847/1538-3881/abd414 (Source for perihelion dates of outer planets: Jupiter to Pluto.)
[M22] Meeus, J. (1998). Astronomical Algorithms, 2nd ed. Willmann-Bell Inc., Richmond, Virginia. ISBN: 978-0-943396-61-3. Chapter 50: Perigee and Apogee of the Moon, pp. 355–358. (Formula for lunar perigee — implemented in MPERC.txt.)
